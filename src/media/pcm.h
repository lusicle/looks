// .pcm layout, little-endian: 'PCM1'(4) channels(u16) bits(u16=16)
// sample_rate(u32) frame_count(u32), then interleaved s16 samples.
...
public:
    ...
    // Zero-fills past EOF; returns only the frames read from the file.
