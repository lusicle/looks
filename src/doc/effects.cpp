...
constexpr ParamDesc kQuantizeParams[] = {
    ...
    {"dither", "dither", 0.0f, 9.0f, 3.0f, "%.0f"},
...
constexpr ParamDesc kGlyphParams[] = {
    ...
    {"set", "set (0=dot 1=ascii 3=braille)", 0.0f, 3.0f, 1.0f, "%.0f"},
...
constexpr ParamDesc kColorScienceParams[] = {
    ...
    {"preset", "stock", 0.0f, 13.0f, 1.0f, "%.0f"},
...
constexpr ParamDesc kGateMaskParams[] = {
    {"gauge", "gauge (s8/16/185/239)", 0.0f, 3.0f, 1.0f, "%.0f"},
...
constexpr ParamDesc kErrorDiffusionParams[] = {
    ...
    {"mode", "mode (0=fs 1=atkinson)", 0.0f, 1.0f, 0.0f, "%.0f"},
...
constexpr EffectInfo kEffectInfos[] = {
    ...
    {"dust_scratches", "Dust & Scratches", kDustScratchesParams, 5,
     FxCategory::Texture},
    ...
    {"rutt_etra", "Rutt-Etra", kRuttEtraParams, 3, FxCategory::Mosaic},
    ...
    {"halftone", "Halftone", kHalftoneParams, 5, FxCategory::Mosaic},
